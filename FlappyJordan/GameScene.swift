...
//  FlappyJordan
//
//  Created by Karan on 2/5/16.
//  Copyright (c) 2016 SimpleK. All rights reserved.
//
    ...
    override func touchesBegan(touches: Set<UITouch>, withEvent event: UIEvent?) {
       /* Called when a touch begins */
        if gameStarted == false {
            ...
            let movePipes = SKAction.moveByX(-distance - 50, y: 0.0, duration: NSTimeInterval(0.01 * distance))
